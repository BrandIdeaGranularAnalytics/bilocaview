    ...
    public function getsubrdbeat($input)
    {
         ...
         array_push($column, array(
          ...
          array_push($column, array(
           ...
           array_push($column, array(
             'title' => 'Sub Distributor code', 'className' => 'text-left'
         ));
          array_push($column, array(
      ...
      // echo $sql;die;
        ...
        $total_potential=count($res);
         ...
         $type_subrd=[1=>'Actual',2=>'Assumed'];
          $test=['No Visit'=>0,'Premium'=>1,'Medium'=>2,'Van Beat'=>3];
        ...
        for($s=0;$s<$total_potential;$s++)
        {
            ...
            $val_data=array(($s+1),$res[$s]['subrd_village'],$res[$s]['subrd_code'],'<a href="#" style="text-decoration:underline;" onClick="show_subrdbeat(0,'.$res[$s]['subrd_id'].')">'.ucwords(strtolower($res[$s]['subrd_name'])).'</a>',$res[$s]['subrd_district'],$res[$s]['subrd_taluk'],$res[$s]['village_name'],'<a href="#" style="text-decoration:underline;" onClick="show_subrdbeat('.$res[$s]['beat_id'].',0)">'.$res[$s]['beat_name'].'</a>',$res[$s]['village_market_id'],$res[$s]['visit_order'],$res[$s]['village_name'],$res[$s]['village_district'],$res[$s]['village_taluk'],$res[$s]['village_state'],$res[$s]['oneway_distance'],$res[$s]['beatween_distance'],$res[$s]['oneway_distance_per_beat'],$res[$s]['covered_outlets'],$res[$s]['covered_village'],$res[$s]['covered_wholesaler'],$res[$s]['covered_visicooler'],$res[$s]['beat_wholesaler'],$res[$s]['covered_cooler_outlets'],$type_subrd[$res[$s]['subrd_type']],$res[$s]['overall_time'],$res[$s]['premium']);
            ...
            if(!in_array($res[$s]['subrd_id'], $subrd_id))
            {
                ...
                $temp['info']='<div class="container-fluid pb-2" style="height:fit-content;color:white !important;"><span class="d-flex flex-row  justify-content-between pt-2"><h5>'.$res[$s]['village_name'].'</h5></span><hr style="border-top: 1px solid white;"><p class="text-wrap"><p><span style="color:rgb(242, 101, 34)">Beat Name : </span>'.$res[$s]['beat_name'].' </p><p><span style="color:rgb(242, 101, 34)">Village Market ID : </span>'.$res[$s]['village_market_id'].' </p><p><span style="color:rgb(242, 101, 34)">Visit Order : </span>'.$res[$s]['visit_order'].' </p><p><span style="color:rgb(242, 101, 34)">Covered Outlets : </span>'.$res[$s]['covered_outlets'].' </p><p><span style="color:rgb(242, 101, 34)">Covered VisiColler: </span>'.$res[$s]['covered_visicooler'].' </p><p><span style="color:rgb(242, 101, 34)">Covered Wholesaler: </span>'.$res[$s]['covered_wholesaler'].' </p><p><span style="color:rgb(242, 101, 34)">State: </span>'.$res[$s]['village_state'].'</p><p><span style="color:rgb(242, 101, 34)">District: </span>'.$res[$s]['village_district'].' </p><p><span style="color:rgb(242, 101, 34)">Taluk: </span>'.$res[$s]['village_taluk'].'</p></div>';
     ...
     public function gethighway($input)
     {
        ...
        for($s=0;$s<$total_potential;$s++)
        {
            ...
            $val_data=array(($s+1),$res[$s]['ccp_name'],$res[$s]['address'],$res[$s]['channel'],$res[$s]['group_name'],$res[$s]['subrd_name'],$res[$s]['subrd_name_type'],$res[$s]['recomend_subrd_name'],$res[$s]['subrd_address'],$cluster_name,'<a href="#" style="text-decoration:underline;" onClick="show_highway('.$res[$s]['highway_id'].')">'.$res[$s]['highway_name'].'</a>',
                );
             array_push($value_data,$val_data);
            ...
            if(!in_array($res[$s]['subrd_id'], $subrd_id))
            {
                array_push($subrd_id,$res[$s]['subrd_id']);
                 ...
                 //    $temp['info']='<div class="tooltip-data"><div class="card"><div class="card-header"><h3>'.$subrd_name.'</h3> </div>'.$res[$s]['sub_text'].'</div></div>';
                     ...
                     $temp['info']='<div class="container-fluid pb-2" style="height:fit-content;color:white !important;"><span class="d-flex flex-row  justify-content-between pt-2"><h5>'.$subrd_name.'</h5></span><hr style="border-top: 1px solid white;"><p><span style="color:rgb(242, 101, 34)">Subrd Code: </span>'.$res[$s]['subrd_code'].'</p><p><span style="color:rgb(242, 101, 34)">Subrd Type: </span>'.$res[$s]['subrd_name_type'].' </p><p><span style="color:rgb(242, 101, 34)">State: </span>'.$res[$s]['state'].'</p><p><span style="color:rgb(242, 101, 34)">District : </span>'.$res[$s]['district'].' </p><p><span style="color:rgb(242, 101, 34)">Taluk: </span>'.$res[$s]['taluk'].' </p><div class="popup-footer" ><span style="background-color:none;text-align:right;" class="navigate_location" geocode="'.$res[$s]['subrd_lat'].','.$res[$s]['subrd_lon'].'" onclick="location_navigate(this)">Click to Navigate</span></div></div>';
                ...
                $temp['info']='<div class="container-fluid pb-2" style="height:fit-content;color:white !important;"><span class="d-flex flex-row  justify-content-between pt-2"><h5>'.$res[$s]['ccp_name'].'</h5></span><hr style="border-top: 1px solid white;"><p class="text-wrap"><span style="color:#00CCCC">'.$res[$s]['address'].'</p><p><span style="color:rgb(242, 101, 34)">Channel: </span>'.$res[$s]['channel'].'</p><p><span style="color:rgb(242, 101, 34)">Subrd Code: </span>'.$res[$s]['subrd_code'].' </p><p><span style="color:rgb(242, 101, 34)">Subrd Name: </span>'.$subrd_name_.'</p><p><span style="color:rgb(242, 101, 34)">State : </span>'.$res[$s]['state'].' </p><p><span style="color:rgb(242, 101, 34)">District: </span>'.$res[$s]['district'].' </p><p><span style="color:rgb(242, 101, 34)">Taluk: </span>'.$res[$s]['taluk'].' </p><p><span style="color:rgb(242, 101, 34)">Village: </span>'.$res[$s]['taluk'].' </p><div class="popup-footer" ><span style="background-color:none;text-align:right;" class="navigate_location" geocode="'.$res[$s]['latitude'].','.$res[$s]['longitude'].'" onclick="location_navigate(this)">Click to Navigate</span></div></div>';

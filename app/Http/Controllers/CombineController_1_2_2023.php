...
class CombineController extends Controller
{
     ...
     public function Combine_subrd($maparray, $type, $main_location, $sub_location,$input_obj,$current_location)
    {
        ...
        $sql="SELECT  a.`refid`, a.`cluster_id`, a.`cluster_name`, a.`state_name`, a.`district_name`, a.`taluk_name`, a.`village_name`, a.`sector`, a.`loc7`, a.`loc9`, a.`loc10`, a.`loc13`, a.`loc12`, a.`market_id`, a.`bi_id`, a.`distance_subrd`, a.`subrd_loaction`, a.`outlet_potential`, a.`population`, a.`taluk_census`, a.`village_census`, a.`village_choc_consmptn`, a.`cluster_tag`, a.`stat`, a.`subrd_type`, a.`is_hub`, a.`hub_id`, a.`subrd_priority`, a.`tsm_id`, a.`village_2011_census`, a.`company_service_id`,if(a.company_service_id=1,'Active',if(a.company_service_id=2,'Initd',if(a.company_service_id=3,'Inactive',if(a.company_service_id=4,'Activtd',if(a.company_service_id=5,'Deactivtd',''))))) company_servcng,b.latitude,b.longitude FROM `subrd_data` as a,town_village_polygon as b  where a.village_census=b.town_village_code and a.taluk_census=b.taluk_code and a.tsm_id=".$userid."  ".$str." and  a.stat='A' and b.stat='A' ";
         ...
         //<p><span style="color:rgb(242, 101, 34)">Market UID: </span><span style="background-color:white;color:black;">'.$final_result[$k]['market_id'].'</span></p>
             $temp['info'] .='<p><span style="color:rgb(242, 101, 34)">BI Location ID: </span><span style="background-color:white;color:black;" >'.$final_result[$k]['bi_id'].' </span></p><div class="popup-footer" ><span style="background-color:none;text-align:right;" class="navigate_location" onclick="view_village_detail('.$detail.')">More Info</span></div></div>';
         ...
         //<p><span style="color:rgb(242, 101, 34)">Market UID: </span><span style="background-color:white;color:black;">'.$value['market_id'].'</span></p>
             $temp2['info'] .='<p><span style="color:rgb(242, 101, 34)">BI Location ID: </span><span style="background-color:white;color:black;" >'.$value['bi_id'].' </span></p><div class="popup-footer" ><span style="background-color:none;text-align:right;" class="navigate_location" onclick="view_village_detail('.$value_json.')">More Info</span></div></div>';
